...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.5]{figures/bank/transactions80/execution\_time\_plot.png}
...
\begin{table}[H]
	...
	\renewcommand{\arraystretch}{1.2} % Erhöhte Zeilenhöhe
	\rowcolors{2}{gray!10}{white} % Alternierende Zeilenfarben ab der zweiten Zeile
	\begin{tabularx}{\textwidth}{>{\hsize=4.65\hsize}X*{8}{>{\hsize=3.3\hsize}X}} % 9 Spalten mit unterschiedlicher Breite
		\toprule
		\rowcolor{gray!20} % Kopfzeile farbig
		\textbf{\makecell[l]{mxa Ver- \\ bindungen}} & 
		\textbf{\makecell[l]{JVT \\ Max \\ RAM \\ in MB}} & 
